...
/**
 * Esta clase es prehecha y ayudó en el trabajo para rellenar de manera más exacta las lineas que se crearon en el proyecto.
 * @author: Profesor Jorge López
 */
public class RellenaConPuntos {
//agraga al poligono todos los puntos de la recta que uno dos puntos
        public synchronized static void nuevaLinea(int nx1,int ny1,int nx2,int ny2, Polygon p){
          ...
          // System.out.println("puntos insertados: "+np);
           if(np<1)return;
           if(npy>npx){
